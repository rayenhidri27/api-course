 ...
 *              "description"="incremente le chrno d'une facture donnée",
 *           }
 *      }
 *   },
 * )
...
class Invoice
{
     ...
     * @Assert\Type(
     *     type="numeric",
     *     message="Le montant de la facture doit etre numérique."
     * )
     */
    private $amount;
     ...
     * @Groups({"invoices_read", "customers_read", "invoices_subresource"})
     * @Assert\DateTime(message="La data doit etre au format YYYY-MM-DD")
     ...
     * @Assert\Type(
     *     type="integer",
     *     message="Le chrono doit etreun nombre"
     * )
     */
    private $chrono;
